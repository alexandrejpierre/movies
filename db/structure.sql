...
CREATE TABLE "preferences" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "movie_id" integer, "user_id" integer, "likes" varchar, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
