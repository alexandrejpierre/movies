...
CREATE TABLE "users" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "pseudo" varchar, "name" varchar, "first_name" varchar, "email" varchar, "fb_connected" varchar, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "password_digest" varchar);
...
CREATE TABLE "tmdbmovies" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "adult" boolean, "backdrop_path" varchar, "belongs_to_collection" varchar, "budget" float, "genres" varchar, "homepage" varchar, "tmdb_id" varchar, "imdb_id" varchar, "original_language" varchar, "original_title" varchar, "overview" text, "popularity" float, "poster_path" varchar, "production_companies" varchar, "production_countries" varchar, "release_date" date, "revenue" float, "runtime" integer, "spoken_languages" varchar, "status" varchar, "tagline" varchar, "title" varchar, "video" boolean, "vote_average" float, "vote_count" integer, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "release_year" integer, "rank" integer, "cast" varchar, "crew" varchar);
CREATE TABLE "preferences" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "movie_id" integer, "user_id" integer, "likes" varchar, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "tmdbmovie_id" integer);
